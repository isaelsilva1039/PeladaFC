    ...
    <div className="w-full max-w-md space-y-8">
      ...
      <Card className="gradient-card border-0 shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Junte-se à maior comunidade de futebol de várzea</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={formAction} className="space-y-4">
            ...
            {state?.success && (
              <div className="bg-green-500/10 border border-green-500/50 text-green-700 dark:text-green-400 px-4 py-3 rounded-lg text-sm">
                {state.success}
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <Input id="name" name="name" type="text" placeholder="Seu nome" required className="h-11" />
            </div>
